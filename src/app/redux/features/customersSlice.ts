...
const dummyTimeline: ActivityTimelineItem[] = [
	{
		...
		description:
			"Invoice #INV-2084 approved for $42,000 by Finance Management for Apex Freight.",
		time: "12m ago",
	},
	{
		id: "act-2",
		...
		description:
			"Batch #SHP-4023 left Singapore port on 'Pacific Voyager' for Oceanic Dynamics.",
		time: "1h ago",
	},
	{
		id: "act-3",
		...
		title: "Customs Alert",
		description:
			"Additional documentation requested for #SHP-48992 in Tokyo for Vanguard Logistics.",
		time: "1h ago",
	},
	{
		id: "act-4",
		...
		title: "Payment Processed",
		description:
			"Invoice #INV-2088 approved for $12,000 by Finance Management for Nova Imports.",
		time: "2h ago",
	},
	{
		id: "act-5",
		...
		title: "Account Hold",
		description:
			"Credit limit exceeded by $15,300 for summit traders. Account placed on hold.",
		time: "2h ago",
	},
];
