...
export interface JobDocument {
	...
	documents: {
		id: string;
		type: string;
		status: "Missing" | "Verified" | "Pending";
		date: string;
	}[];
	internalNotes: {
		id: string;
	...
	activityLog: {
		...
		subtitle: string;
		time: string;
		type: "status" | "document" | "note" | "general";
	}[];
	additionalExpenses?: {
		id: string;
		title: string;
...
const detailedMockData = {
	...
	actionsRequired: [
		{
			id: "1",
			title: "Missing BL Document",
			description:
				"Carrier evergreen has not received the Master BL. Shipment cannot clear customs without it.",
			type: "danger",
			actionText: "Upload",
		},
		{
			...
			description:
				"Client approval needed for revised HS code mapping for electronics batch US-99.",
			type: "info",
			actionText: "Approve",
		},
		{
			...
			description:
				"Last-mile drayage from Long Beach port to warehouse US-L81 needs scheduling.",
			type: "warning",
			actionText: "Assign",
		},
		{
			id: "4",
			title: "Carrier Confirmation Pending",
			description:
				"Waiting for FastShip to confirm truck assignment for last-mile delivery.",
			type: "warning",
	...
	valueAddServices: [
		{
			...
			description: "Policy #INS-9002",
			icon: "shield",
		},
		{
			id: "2",
			name: "Fumigation",
			description: "Cert Issued Oct 10",
			icon: "droplet",
		},
		{
			id: "3",
			name: "Warehousing",
			description: "3 Days Pre-Gate",
			icon: "warehouse",
		},
	],
	containerDetails: [
	...
	internalNotes: [
		{
			id: "1",
			content:
				"Customer requested a 5% volume discount if they confirm by Friday.",
			author: "Sales Team",
			time: "2 hours ago",
		},
		{
			id: "2",
			content:
				"Customer requested a 4% volume discount if they confirm by Friday.",
			author: "Sales Team",
			time: "3 hours ago",
		},
	],
	activityLog: [
		{
			...
			subtitle: "Today, 09:15 AM - System Automator",
			time: "Today",
			type: "status",
		},
		{
			id: "2",
			title: "Document 'Commercial Invoice' verified",
			subtitle: "Yesterday, 04:30 PM - Sarah (FFT)",
			time: "Yesterday",
			type: "document",
		},
		{
			id: "3",
			title: 'New note: "Customer requested expedited delivery."',
			subtitle: "Oct 22, 11:10 AM - Alex Chen",
			time: "Oct 22",
			type: "note",
		},
		{
			id: "4",
			title: "Job Created",
			subtitle: "Oct 12, 14:20",
			time: "Oct 12",
			type: "general",
		},
	],
	additionalExpenses: [
		{ id: "1", title: "Port handling Fee", amount: 3205.0 },
		{
			id: "2",
			title: "Customers Clearance",
			status: "Pending",
			amount: 3250.0,
		},
		{
