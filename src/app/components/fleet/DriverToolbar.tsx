...
const typeOptions = ["All Types", "Assigned", "Unassigned"];
const statusOptions = ["Status: All", "Assigned", "Available", "Leave"];
const dateOptions = [
	"Date: Last 30 Days",
	"Date: Last 90 Days",
	"Date: This Year",
	...
	return (
		<div className="flex flex-col gap-4 py-5 2xl:flex-row 2xl:items-center 2xl:justify-between">
			...
			<div className="flex flex-wrap gap-3 justify-start 2xl:justify-end shrink-0">
				<button
					className="rounded-md px-6 py-2 text-sm font-medium border border-[#0c599b] text-[#0c599b] hover:bg-gradiate hover:text-white transition-colors"
				>
					Export
				</button>
				<button
