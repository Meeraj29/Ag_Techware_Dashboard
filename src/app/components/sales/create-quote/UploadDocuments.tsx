	...
	return (
		<div className="w-full mb-12">
			<h2 className="text-xl font-medium text-gray-900 mb-4">
				Upload Documents{" "}
				<span className="text-gray-500 font-medium text-lg">(Optional)</span>
			</h2>
			...
			{files.length > 0 && (
				<div className="mt-4 flex flex-col gap-2">
					{files.map((file, idx) => (
						<div
							key={idx}
							className="flex items-center justify-between p-3 bg-[#F9F9F9] border border-gray-200 rounded-md"
						>
