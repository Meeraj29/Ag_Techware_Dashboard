	...
	return (
		<div className="flex flex-col h-full">
			<div className="flex justify-between items-center mb-4">
				...
				<span className="text-[#059669] text-[14px] font-medium">
					Current Session
				</span>
			</div>
			...
			<div className="space-y-4">
				{/* Container Number */}
				<div>
					<label className="text-[14px] font-medium text-[#000000] mb-2">
						Container Number
					</label>
					<input
						type="text"
					...
					<div>
						...
						<div className="relative">
							<select
								value={cargoWeight}
								onChange={(e) =>
									handleFieldChange("cargoWeight", e.target.value)
								}
								className="w-full bg-[#F4F4F4] border-none rounded-lg px-4 py-3 text-[14px] text-[#000000] font-medium appearance-none focus:outline-none focus:ring-1 focus:ring-primary"
							>
								<option>22500</option>
					...
					<div>
						...
						<div className="relative">
							<select
								value={tareWeight}
								onChange={(e) =>
									handleFieldChange("tareWeight", e.target.value)
								}
								className="w-full bg-[#F4F4F4] border-none rounded-lg px-4 py-3 text-[14px] text-[#000000] font-medium appearance-none focus:outline-none focus:ring-1 focus:ring-primary"
							>
								<option>3750</option>
				...
				<div className="bg-[#BA1A1A4D] rounded-[24px] p-4 flex gap-3 mt-3">
					...
					<p className="text-[14px] text-[#BA1A1A] font-regular leading-relaxed pr-2">
						Overweight Warning: The calculated VGM exceeds the maximum payload
						for a 40' Dry HC container (Max: 26,000 KG). Verification required.
					</p>
				</div>
				...
				<div className="space-y-4">
					<button
						...
						className="w-full bg-gradiate hover:from-[#044890] hover:to-[#044890] text-white py-3 rounded-lg text-[16px] font-medium transition-colors"
					>
						Calculate VGM
					</button>
