...
const mockDetails: Record<string, CustomerDetail> = {
	"CUS-1029": {
		...
		systemNote:
			"Account eligible for Tier-1 preferential shipping rates starting next billing cycle.",
		timeline: [
			{
				id: "t1",
				dateTime: "24-11-2026",
				eventType: "Shipment #XF-902-L Arrival",
				operators: "System (Auto)",
				status: "Pending",
			},
			{
				id: "t2",
				dateTime: "23-11-2026",
				eventType: "Credit Limit Increase Request",
				operators: "Marcus Chen",
				status: "Verified",
			},
			{
				id: "t3",
				dateTime: "22-11-2026",
				eventType: "KYC Verification Renewal",
				operators: "Legal Team",
				status: "Delayed",
			},
			{
				id: "t4",
				dateTime: "21-11-2026",
				eventType: "TechNova Industries",
				operators: "Marcus Chen",
				status: "Verified",
			},
		],
		internalNotes: [
			{
				id: "n1",
				text: "Customer prefers consolidated billing on the 15th of each month.",
				author: "Anita K.",
				daysAgo: "2 days ago",
			},
			{
				id: "n2",
				text: "Urgent: Address validation required for new Singapore warehouse.",
				author: "System",
				daysAgo: "5 days ago",
			},
		],
	...
	"CUS-1028": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "20-11-2026",
				eventType: "Shipment #GF-701 Departure",
				operators: "System (Auto)",
				status: "Verified",
			},
			{
		...
		internalNotes: [
			{
				id: "n1",
				text: "Client requests invoice copies in Spanish.",
				author: "Maria L.",
				daysAgo: "1 day ago",
			},
		],
	...
	"CUS-1027": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "22-11-2026",
				eventType: "Credit Warning Issued",
				operators: "System (Auto)",
				status: "Pending",
			},
			{
		...
		internalNotes: [
			{
				id: "n1",
				text: "Monitor account closely — credit limit almost exhausted.",
				author: "Risk Team",
				daysAgo: "3 days ago",
			},
		],
	...
	"CUS-1026": {
		...
		internalNotes: [
			{
				id: "n1",
				text: "High-volume exporter - dedicated account manager assigned.",
				author: "Ops Team",
				daysAgo: "1 day ago",
			},
		],
		addresses: [
			{
				...
				addressLines: ["DIFC Gate Building,", "Dubai, UAE"],
			},
		],
	},
	"CUS-1025": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "21-11-2026",
				eventType: "Account Placed on Hold",
				operators: "System (Auto)",
				status: "Pending",
			},
		],
		internalNotes: [
			{
				id: "n1",
				text: "Account on hold pending overdue payment clearance.",
				author: "Finance Team",
				daysAgo: "4 days ago",
			},
		],
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "EuroLine Logistics BV",
				addressLines: ["Coolsingel 40,", "Rotterdam 3011 AD,", "Netherlands"],
			},
		],
	},
	"CUS-1024": {
		...
		systemNote:
			"Excellent payment history - eligible for credit limit increase.",
		timeline: [
			{
				id: "t1",
				dateTime: "24-11-2026",
		...
		internalNotes: [
			{
				id: "n1",
				text: "Top-tier client - zero late payments in 5 years.",
				author: "Account Team",
				daysAgo: "7 days ago",
			},
		],
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "Oceanic Dynamics Ltd",
				addressLines: ["1 Canada Square,", "London E14 5AB, UK"],
			},
		],
	},
	"CUS-1023": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "22-11-2026",
				eventType: "Shipment Cleared Customs",
				operators: "System (Auto)",
				status: "Verified",
			},
		],
		internalNotes: [
			{
				id: "n1",
				text: "Reliable client - always pays within 15-day terms.",
				author: "Finance Team",
				daysAgo: "10 days ago",
			},
		],
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "Apex Freight Solutions Inc",
				addressLines: [
					"500 Boylston Street,",
					"Boston, MA 02116,",
					"United States",
	...
	"CUS-1022": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "24-11-2026",
				eventType: "Batch Cleared at Port",
				operators: "System (Auto)",
				status: "Verified",
			},
		],
		internalNotes: [
			{
				id: "n1",
				text: "Strategic account - quarterly business reviews scheduled.",
		...
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "Nova Imports International Ltd",
				addressLines: ["30 St Mary Axe,", "London EC3A 8BF,", "United Kingdom"],
			},
		],
	},
	"CUS-1021": {
		...
		systemNote:
			"Account on hold - credit limit exceeded. Immediate review required.",
		timeline: [
			{
				id: "t1",
				dateTime: "23-11-2026",
		...
		internalNotes: [
			{
				id: "n1",
				text: "Credit limit exceeded - account on hold until settlement.",
				author: "Finance Team",
				daysAgo: "3 days ago",
			},
		],
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "Summit Traders GmbH",
				addressLines: ["Maximilianstrasse 13,", "Munich 80539,", "Germany"],
			},
		],
	},
	"CUS-1020": {
		...
		timeline: [
			{
				id: "t1",
				dateTime: "23-11-2026",
				eventType: "Late Payment Warning Issued",
				operators: "System (Auto)",
				status: "Pending",
			},
			{
		...
		internalNotes: [
			{
				id: "n1",
				text: "Late payment rate increasing - flagged for quarterly review.",
				author: "Risk Team",
				daysAgo: "1 day ago",
			},
		],
		addresses: [
			{
				id: "a1",
				type: "Billing Address",
				companyName: "Pioneer Exports Inc",
				addressLines: [
					"350 Fifth Avenue,",
					"New York, NY 10118,",
					"United States",
...
const customerDetailSlice = createSlice({
	...
	reducers: {
		...
		addNote(
			state,
			action: PayloadAction<{ customerId: string; note: InternalNote }>,
		) {
...
export const { setActiveTab, setSelectedCustomer, addNote } =
