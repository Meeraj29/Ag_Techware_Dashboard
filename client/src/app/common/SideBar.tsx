...
export default function SideBar({ 
  ...
  return (
    <div className="flex h-full flex-col border-r border-gray-200 bg-white shadow-sm overflow-hidden">
      {/* Logo Area */}
      <div className={`flex h-16 items-center border-b border-gray-100 shrink-0 px-6 ${isCollapsed ? 'lg:justify-center lg:px-2' : ''}`}>
