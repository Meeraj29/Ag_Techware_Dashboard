  ...
  return (
    <div className="p-3 sm:p-6 bg-[#f8f9fa] min-h-screen space-y-4 sm:space-y-6">
      <div className="mx-auto max-w-[1560px] space-y-4 sm:space-y-6">
          ...
          <div className="mt-6">
            <h2 className="text-base font-bold text-gray-900">
              {activeTab === "Vehicles" ? "Vehicle Management" :
                activeTab === "Trip Management" ? "Trip Management" :
                  activeTab === "Purchase Orders" ? "Purchase Orders" :
                    activeTab === "Maintenance" ? "Fleet Maintenance" :
                      activeTab === "Tire Management" ? "Tire Management" :
                        activeTab === "Document & Compliance" ? "Documents & Compliance" :
                          activeTab === "Drivers" ? "Driver Directory" :
                            activeTab}
            </h2>
            <p className="mt-1 text-xs text-gray-400">
              {activeTab === "Vehicles" ? "Track, monitor, and maintain all vehicles efficiently." :
                activeTab === "Trip Management" ? "Real-time Oversight of Ongoing and upcoming logistics Operations." :
                  activeTab === "Purchase Orders" ? "Create, track, and manage purchase requests efficiently." :
                    activeTab === "Maintenance" ? "Schedule routine services and monitor asset health across the entire operational grid." :
                      activeTab === "Tire Management" ? "Real-time Oversight of Ongoing and upcoming logistics Operations." :
                        activeTab === "Document & Compliance" ? "Manage and track fleet-wide regulatory compliance documentation." :
                          activeTab === "Drivers" ? "Manage and monitor fleet operator assignments and compliance." :
        ...
        {(activeTab === "Vehicles" || activeTab === "Trip Management" || activeTab === "Purchase Orders" || activeTab === "Maintenance" || activeTab === "Tire Management" || activeTab === "Document & Compliance" || activeTab === "Drivers") && (
