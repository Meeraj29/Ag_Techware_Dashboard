    ...
    <div className="w-full space-y-4 p-4 sm:p-4 bg-[#F4F4F4] min-h-[calc(100vh-80px)] overflow-y-auto scrollbar-hide">
      ...
      <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 p-4 sm:p-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          <div>
            <h1 className="text-[20px] sm:text-[20px] font-semibold text-[#000000]">VGM Calculator Overview</h1>
            <p className="text-[16px] text-[#000000B2] font-regular mt-0.5">SOLAS Compliant Verified Gross Mass Management</p>
          </div>
