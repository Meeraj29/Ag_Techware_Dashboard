			...
			<div className="flex flex-col h-full bg-white rounded-3xl p-4  border border-gray-100 overflow-hidden">
				...
				<div className="w-full flex justify-between items-center mb-4 px-4">
					...
					<div className="flex items-center gap-3">
						<Button
							variant="outline"
							className="border-red-500 text-red-500 hover:bg-red-50 font-semibold px-6 cursor-pointer"
						>
							Cancel
						</Button>
						<Button
							variant="outline"
							className="border-[#075FB7] text-[#075FB7] hover:bg-blue-50 font-semibold px-6 cursor-pointer"
						>
							Edit Quote
						</Button>
						<Button
							variant="gradient"
							className="text-white font-semibold px-6 cursor-pointer"
						>
							Save & Download Quote
						</Button>
					</div>
