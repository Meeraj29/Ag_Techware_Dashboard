...
import AdditionalExpenses from "@/app/components/clearance/details/AdditionalExpenses";

export default function ClearanceJobDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-full p-6 lg:p-8 bg-[#F8F9FA] flex flex-col">
      <div className="w-full mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <JobDetailsHeader job={job} isClearance={true} />
        </div>
        ...
        <div className="flex flex-col gap-6 mt-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <AdditionalExpenses expenses={job.additionalExpenses} />
          </div>
