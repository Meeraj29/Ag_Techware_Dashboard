			...
			<div className="bg-white rounded-2xl shadow-lg w-full max-w-3xl overflow-hidden animate-in fade-in zoom-in duration-200">
				<div className="p-8">
					...
					<div className="space-y-6">
						...
						<div>
							...
							<div className="relative">
								<select
									defaultValue=""
									className="w-full p-4 bg-[#F9F9F9] border border-dashed border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-gray-700 appearance-none cursor-pointer"
								>
					...
					<div className="flex justify-end gap-4 mt-8">
						...
						<Button
							variant="gradient"
							className="px-8 font-semibold bg-[#054890] text-white cursor-pointer"
						>
							Add Note
						</Button>
					</div>
