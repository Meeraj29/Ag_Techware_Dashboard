...
export default function QuoteDetailsHeader({
	...
	const formattedDate = new Date(quotation.validFrom).toLocaleDateString(
		"en-US",
		{
			month: "short",
			day: "numeric",
					...
					<div className="flex flex-wrap items-center gap-2 text-sm text-gray-500 font-medium">
						<span>
							...
							<span className="text-black text-base font-medium">
								{quotation.tradeType} ({quotation.mode} Freight)
							</span>
						</span>
						<span className="text-gray-300">|</span>
						<span className="text-[#00000075] font-normal">
							Date: {formattedDate}
						</span>
					</div>
				</div>
