  ...
  return (
    <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 sm:px-8 py-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <h1 className="text-lg sm:text-xl font-semibold text-black">Create Quotation</h1>
      </div>

      <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full md:w-auto">
        <Button variant="outline" className="flex-1 md:flex-none justify-center border-red-500 text-red-500 hover:bg-red-50 font-semibold px-3 sm:px-6 whitespace-nowrap">
          Cancel
        </Button>
        <Button variant="outline" className="flex-1 md:flex-none justify-center border-[#075FB7] text-[#075FB7] hover:bg-blue-50 font-semibold px-3 sm:px-6 whitespace-nowrap">
          Save As Draft
        </Button>
        <Button
          variant="default"
