...
export default function GeneralDetails() {
  const fields: FieldProps[] = [
    ...
    { label: "Place Of Carrier Receipt", type: "select", placeholder: "Choose location" },

    { label: "Port of Loading", type: "select", placeholder: "Select Location" },
    { label: "Estimated Time Of Departure", type: "date", placeholder: "__/__/___" },
    { label: "Port of Destination", type: "select", placeholder: "Choose location" },

    { label: "Estimated Time Of Arrival", type: "date", placeholder: "__/__/___" },
    { label: "Place Of Carrier Delivery", type: "select", placeholder: "Choose location" },
    { label: "Destination Port Free Days", type: "select", placeholder: "Choose location", required: false },

    { label: "Origin Carrier Free Days", type: "select", placeholder: "Choose location", required: false },
    { label: "Destination Carrier Free Days", type: "select", placeholder: "Choose location", required: false },
