  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
        <h2 className="text-[20px] font-semibold text-[#000000]">Active Shipments</h2>
          ...
          <div className="overflow-hidden">
            <table className="min-w-full">
              <thead className="bg-[#F4F4F4]">
                <tr>
                  <th scope="col" className="px-5 py-3.5 text-left text-[14px] font-medium text-[#000000CC] whitespace-nowrap rounded-tl-[10px]">
                    Container #
                  </th>
                  <th scope="col" className="px-5 py-3.5 text-left text-[14px] font-medium text-[#000000CC] whitespace-nowrap">
                    ISO Type
                  </th>
                  <th scope="col" className="px-5 py-3.5 text-left text-[14px] font-medium text-[#000000CC] whitespace-nowrap">
                    Cargo Wt (KG)
                  </th>
                  <th scope="col" className="px-5 py-3.5 text-left text-[14px] font-medium text-[#000000CC] whitespace-nowrap rounded-tr-[10px]">
                    Tare
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100/50 bg-white">
                {shipments.map((shipment, index) => (
                  <tr key={index} className="transition-colors even:bg-[#F9F9F9]">
