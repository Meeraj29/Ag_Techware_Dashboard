    ...
    <div className="bg-white rounded-3xl border border-gray-200 p-6 w-full">
      ...
      <div className="relative pl-6 flex flex-col gap-6">
        ...
        {timeline.map((item: ActivityTimelineItem) => {
          ...
          return (
            <div key={item.id} className="relative flex justify-between items-start gap-4">
              {/* Timeline marker */}
              <div className="absolute -left-7.75 mt-0.5 z-10">
                <div className={`w-8 h-8 rounded-full border ${styles.bg} ${styles.border} ${styles.text} flex items-center justify-center`}>
