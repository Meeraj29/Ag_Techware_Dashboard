  ...
  return (
    <div className="bg-white rounded-[16px] border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
        <InputField label="Branch Name" id="branch-name" required placeholder="Branch Name" />

        <div className="flex flex-col gap-1.5 justify-end">
          <div className="flex items-center gap-6 py-2.5">
            <label className="flex items-center gap-2 cursor-pointer text-[13px] text-gray-700">
              <input type="radio" name="resident-type" value="parent" className="accent-primary" />
              Is Parent Company
            </label>
            <label className="flex items-center gap-2 cursor-pointer text-[13px] text-gray-700">
              <input type="radio" name="resident-type" value="non-resident" defaultChecked className="accent-primary" />
              Non Resident
            </label>
          </div>
        </div>

        <InputField label="PIC Email ID" id="pic-email" placeholder="PIC Email ID" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="bank-name" className="text-[13px] font-semibold text-gray-700">Bank Name</label>
        ...
        <InputField label="Account No." id="account-no" required placeholder="ACC Number" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
        ...
        <InputField label="PIC Phone No" id="pic-phone" placeholder="PIC Phone No" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="flex flex-col justify-end gap-3 pb-1">
          <ToggleField label="Active Flag" id="active-flag" defaultChecked={true} />
        </div>
