  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex items-center gap-1.5 text-[14px] text-black/50 mb-4">
        <Link href="/dashboard/customers" className="hover:text-primary transition">Customer</Link>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <span className={`text-[12px] font-semibold px-2.5 py-1 rounded-full ${statusColors[detail.status]}`}>
