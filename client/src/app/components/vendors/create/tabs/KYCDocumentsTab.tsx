	...
	return (
		<div className="p-6 bg-white rounded-b-xl shadow-sm">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10 mb-8">
				{/* Company Reg No */}
				<div>
					<label className="block text-base font-medium text-black  mb-2 uppercase tracking-wide">
						...
						<div className="flex flex-wrap gap-2">
							{formState.kycDoc1Name
								...
								.map((fileName, idx) => (
									<div
										key={idx}
										className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-md text-sm text-gray-700"
									>
