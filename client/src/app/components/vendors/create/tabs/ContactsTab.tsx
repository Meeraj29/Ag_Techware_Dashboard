...
import {
	...
	updateContact,
	removeContact,
} from "../../../../redux/features/vendor/vendorFormSlice";
				...
				<table className="w-full text-left border-collapse min-w-[800px]">
					<thead>
						<tr className="bg-[#F2F2F2] border-b border-gray-200">
							<th className="py-4 px-6 text-base font-medium text-black  w-16">
								#
							</th>
							<th className="py-4 px-6 text-base font-medium text-black w-1/4">
								Contact Name
							</th>
							<th className="py-4 px-6 text-base font-medium text-black w-1/4">
								Address
							</th>
							<th className="py-4 px-6 text-base font-medium text-black w-1/5">
								Phone Number
							</th>
							<th className="py-4 px-6 text-base font-medium text-black w-1/5">
								Email
							</th>
							<th className="py-4 px-6 text-base font-medium text-black w-24">
								Action
							</th>
						</tr>
					</thead>
