  ...
  return (
    <div className="p-6 bg-white rounded-b-xl shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
        ...
        {/* Name */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Name <span className="text-[#BA1A1A]">*</span></label>
          <input
            type="text"
            placeholder="Name"
        ...
        {/* Code */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Code <span className="text-[#BA1A1A]">*</span></label>
          <input
            type="text"
            placeholder="code"
        ...
        {/* Location */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Location</label>
          <input
            type="text"
        ...
        {/* Effective From */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Effective From</label>
          <input
            type="date"
        ...
        {/* Mobile no */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Mobile no</label>
          <input
            type="text"
