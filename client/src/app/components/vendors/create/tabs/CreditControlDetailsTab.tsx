  ...
  return (
    <div className="p-6 bg-white rounded-b-xl shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
        ...
        {/* Date From */}
        <div>
          <label className="block text-base font-medium text-black mb-2">Date From</label>
          <input
            type="date"
        ...
        {/* date To */}
        <div>
          <label className="block text-base font-medium text-black mb-2">Date To</label>
          <input
            type="date"
            placeholder="Date To"
        ...
        {/* Period(days) */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Period(days)</label>
          <input
            type="number"
            placeholder="0"
        ...
        {/* Amount */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Amount</label>
          <input
            type="number"
            placeholder="0"
        ...
        {/* Currency */}
        <div>
          <label className="block text-base font-medium text-black  mb-2">Currency</label>
          <select
