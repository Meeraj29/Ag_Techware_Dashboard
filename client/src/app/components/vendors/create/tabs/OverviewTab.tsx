	...
	return (
		<div className="p-6 bg-white rounded-b-xl shadow-sm">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8 mb-10">
				...
				<div>
					<label className="block text-base font-medium text-black  mb-2">
						Party Shortcode <span className="text-[#BA1A1A]">*</span>
					</label>
					<input
						type="text"
				...
				<div>
					<label className="block text-base font-medium text-black  mb-2">
						Party Type <span className="text-[#BA1A1A]">*</span>
					</label>
					<select
				...
				<div>
					<label className="block text-base font-medium text-black  mb-2">
						Currency <span className="text-[#BA1A1A]">*</span>
					</label>
					<select
				...
				<div>
					<label className="block text-base font-medium text-black  mb-2">
						Import/Export <span className="text-[#BA1A1A]">*</span>
					</label>
					<select
				...
				<div className="flex flex-col gap-4">
					<label className="flex items-center gap-3 cursor-pointer">
						<input
							...
							onChange={(e) =>
								handleChange("isParentCompany1", e.target.checked)
							}
					...
					<label className="flex items-center gap-3 cursor-pointer">
						<div
							onClick={() =>
								handleChange("billingParty", !formState.billingParty)
							}
							className={`w-8 h-4 flex items-center rounded-full p-0.5 transition-colors border ${
								formState.billingParty
									? "bg-primary border-primary"
									: "bg-[#E6E6E6] border-none"
							}`}
						>
							<div
				...
				<div className="flex flex-col gap-4">
					...
					<label className="flex items-center gap-3 cursor-pointer">
						<input
							...
							onChange={(e) =>
								handleChange("isParentCompany3", e.target.checked)
							}
							className="w-4 h-4 text-primary border-gray-300 rounded focus:ring-primary"
						/>
						<span className="text-base font-medium text-black">
				...
				<div className="flex flex-col gap-4">
					<label className="flex items-center gap-3 cursor-pointer">
						<input
							...
							onChange={(e) =>
								handleChange("isRegisteredCompany", e.target.checked)
							}
							className="w-4 h-4 text-primary border-gray-300 rounded focus:ring-primary"
						/>
						<span className="text-base font-medium text-black">
					...
					<label className="flex items-center gap-3 cursor-pointer">
						<div
							onClick={() =>
								handleChange("groupCompanies", !formState.groupCompanies)
							}
							className={`w-8 h-4 flex items-center rounded-full p-0.5 transition-colors border ${
								formState.groupCompanies
									? "bg-primary border-primary"
									: "bg-[#E6E6E6] border-none"
							}`}
						>
