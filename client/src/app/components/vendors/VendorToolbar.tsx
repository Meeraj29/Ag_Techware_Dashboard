...
import { setSearchQuery } from "../../redux/features/vendorSlice";
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center px-6 py-4 gap-4">
      <div className="relative w-full max-w-sm">
        ...
        <input
          ...
          className="block w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm focus:border-primary focus:ring-1 focus:ring-primary focus:bg-white outline-none transition-all"
        />
      </div>
