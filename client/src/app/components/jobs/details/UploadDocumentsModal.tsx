...
export default function UploadDocumentsModal({ isOpen, onClose, jobId }: UploadDocumentsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-3xl flex flex-col shadow-2xl p-8">
        <h2 className="text-xl font-semibold text-center text-gray-900 mb-8">Upload Documents</h2>
