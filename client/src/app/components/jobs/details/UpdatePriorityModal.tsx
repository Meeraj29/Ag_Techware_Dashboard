			...
			<div className="relative bg-white rounded-2xl w-full max-w-sm flex flex-col shadow-2xl p-8">
				...
				<div className="flex items-center justify-between gap-4 mt-2">
					<Button
						variant="outline"
						onClick={onClose}
						className="flex-1 h-11 rounded-xl cursor-pointer text-sm font-medium border-2 border-[#075FB7] text-[#075FB7]"
					>
						Cancel
					</Button>
					<Button
						...
						className="flex-1 h-11 cursor-pointer rounded-xl text-sm font-medium  hover:bg-[#075FB7]/90 text-white"
					>
						Update
					</Button>
				</div>
