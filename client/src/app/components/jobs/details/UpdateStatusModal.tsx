...
export default function UpdateStatusModal({ isOpen, onClose, jobId }: UpdateStatusModalProps) {
  ...
  const displayJobId = jobId?.startsWith('#') ? jobId.substring(1) : (jobId || "");
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-4xl flex flex-col shadow-2xl p-8">
        <h2 className="text-lg font-semibold text-center text-gray-900 mb-8">Update Status</h2>

        <div className="grid grid-cols-3 gap-4 mb-6">
          <div>
            <label className="block text-xs font-medium text-gray-900 mb-2">Job ID</label>
            <input
              type="text"
              value={jobIdInput}
          ...
          <div>
            <label className="block text-xs font-medium text-gray-900 mb-2">Updated By</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-medium text-gray-900 mb-2">Date & Time</label>
            <input
              type="text"
              value={dateInput}
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            >
              <option value="" disabled>Choose transport, tracking, Financial etc.,</option>
        ...
        <div className="mb-8">
          ...
          <div className="border border-dashed border-gray-400 rounded-xl bg-[#F9FAFB] py-12 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <p className="text-[11px] text-gray-400 font-medium tracking-wide">PDF or DOC files only, up to 5MB</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <Button variant="gradient" onClick={handleUpdate} className="px-10 h-11 cursor-pointer rounded-xl text-sm font-medium hover:bg-[#075FB7]/90 text-white">
            Update
          </Button>
        </div>
      </div>
