  ...
  return (
    <div className="bg-[#F4F4F4] rounded-2xl p-6 flex flex-col justify-between h-36 border border-gray-100 relative overflow-hidden">
      <div className="flex justify-between items-start z-10">
        <h2 className="text-3xl font-medium text-gray-900 tracking-tight">{value}</h2>
      ...
      <div className="flex justify-between items-center z-10">
        ...
        <span className={`text-xs font-medium px-3 py-1 rounded-full ${badgeClasses[badgeType]}`}>
          {badge}
        </span>
      </div>
    </div>
