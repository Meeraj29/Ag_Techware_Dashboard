		...
		<div className="bg-white p-6 rounded-2xl shadow-sm mb-6">
			...
			<div className="w-full">
				...
				<div className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-4 mb-2 px-2">
					...
					<div className="text-[13px] font-bold text-gray-900 w-12 text-center">
						Action
					</div>
				</div>
				...
				<div className="flex flex-col gap-3">
					{containers.map((container) => (
						<div
							key={container.id}
							className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-4 items-center"
						>
							<input
								type="text"
								...
								onChange={(e) =>
									handleUpdateContainer(container.id, "type", e.target.value)
								}
							...
							<input
								...
								onChange={(e) =>
									handleUpdateContainer(container.id, "weight", e.target.value)
								}
								className="w-full bg-[#F3F4F6] text-gray-900 rounded-lg px-4 py-2.5 text-[13px] border border-transparent focus:border-[#075FB7] focus:ring-1 focus:ring-[#075FB7] outline-none"
							/>
							<input
