...
export default function FastagStats() {
	...
	return (
		<div className="mt-4 space-y-4">
			...
			<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 rounded-xl bg-red-50 border border-red-100 p-4 text-xs">
				<div className="flex gap-3 items-start">
					<div className="rounded-lg bg-red-100 p-2 text-red-600 mt-0.5 sm:mt-0">
			...
			<div className="grid gap-4 sm:grid-cols-3">
				...
				<div className="flex justify-between rounded-xl bg-[#f8f9fa] border border-gray-100 p-4 h-[105px]">
					<div className="flex flex-col justify-between">
						...
						<p className="text-[10px] text-gray-400">Across 84 active tags</p>
					</div>
				...
				<div className="flex justify-between rounded-xl bg-[#f8f9fa] border border-gray-100 p-4 h-[105px]">
					<div className="flex flex-col justify-between">
						...
						<p className="text-[10px] text-gray-400">October 2023</p>
					</div>
					<div className="flex flex-col justify-between items-end">
						<div className="rounded-xl bg-white p-2 shadow-sm border border-gray-100 text-gray-400">
				...
				<div className="flex justify-between rounded-xl bg-[#f8f9fa] border border-gray-100 p-4 h-[105px]">
					<div className="flex flex-col justify-between">
						...
						<p className="text-[10px] text-gray-400">Fuel &amp; Parking</p>
					</div>
					<div className="flex flex-col justify-between items-end">
						<div className="rounded-xl bg-white p-2 shadow-sm border border-gray-100 text-gray-400">
							<Layers className="h-4 w-4" />
						</div>
						<span className="rounded-full bg-emerald-50 border border-emerald-100 px-2 py-0.5 text-[10px] font-bold text-emerald-600 flex items-center gap-0.5">
							{additionalExpensesTrend}
						</span>
					</div>
				</div>
