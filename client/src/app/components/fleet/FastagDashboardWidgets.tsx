			...
			<div className="rounded-[24px] border border-gray-100 bg-white p-5 shadow-sm flex flex-col justify-between">
				<div>
					...
					<div className="space-y-2">
						{[
							{
								title: "Diesel Refill - Shell Pune",
								sub: "MH-12-QE-1230 • Today, 10:15 AM",
								val: "₹8,450",
								label: "VERIFIED",
								lCol: "bg-blue-50 text-blue-600 border-blue-100",
								icon: "⛽",
							},
							{
								title: "Parking - IGI Airport T3",
								sub: "DL-10-ZZ-0012 • Yesterday",
								val: "₹450",
								label: "PENDING",
								lCol: "bg-amber-50 text-amber-600 border-amber-100",
								icon: "🅿️",
							},
							{
								title: "Diesel Refill - HP Delhi",
								sub: "HR-55-AT-4432 • 22 Oct",
								val: "₹12,200",
								label: "VERIFIED",
								lCol: "bg-blue-50 text-blue-600 border-blue-100",
								icon: "⛽",
							...
							<div
								key={i}
								className="flex items-center justify-between p-3 rounded-xl border border-gray-50 bg-[#f8f9fa]"
							>
								...
								<div className="text-right flex flex-col items-end">
									...
									<span
										className={`text-[8px] font-bold tracking-wide px-1.5 py-0.5 rounded border mt-0.5 ${exp.lCol}`}
									>
										{exp.label}
									</span>
								</div>
				...
				<button className="text-xs font-bold text-blue-600 hover:underline text-center w-full mt-4 block">
					View All Expenses
				</button>
			</div>
				...
				<div className="rounded-[24px] border border-gray-100 bg-white p-5 shadow-sm">
					...
					<div className="flex items-center gap-6">
						<div className="relative flex items-center justify-center w-20 h-20 rounded-xl bg-amber-800 border-4 border-amber-900 text-white flex-col">
							<span className="text-[9px] uppercase tracking-wider text-amber-200">
								Total
							</span>
						...
						<div className="flex-1 space-y-2 text-[11px]">
							<div className="flex justify-between items-center">
								<div className="flex items-center gap-1.5 font-medium text-gray-600">
									<span className="h-2 w-2 rounded-full bg-blue-600" /> FASTag
									(Tolls)
								</div>
							...
							<div className="flex justify-between items-center">
								<div className="flex items-center gap-1.5 font-medium text-gray-600">
									<span className="h-2 w-2 rounded-full bg-amber-700" /> Fuel
									Costs
								</div>
							...
							<div className="flex justify-between items-center">
								<div className="flex items-center gap-1.5 font-medium text-gray-600">
									<span className="h-2 w-2 rounded-full bg-slate-500" /> Parking
									& Fine
								</div>
				...
				<div className="rounded-[24px] border border-gray-100 bg-white p-5 shadow-sm">
					...
					<div className="space-y-1 text-xs">
						{[
							...
							<div
								key={idx}
								className="flex justify-between py-2 border-b border-gray-50 last:border-0 font-medium text-gray-600"
							>
								<span>{item.reg}</span>
