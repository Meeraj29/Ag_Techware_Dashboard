				...
				return (
					...
					>
						<div className="flex flex-col justify-between">
							...
							<p
								className={`text-[10px] font-medium ${card.trend === "up" ? "text-emerald-600" : "text-gray-500"}`}
							>
								{card.subtext}
							</p>
						</div>
