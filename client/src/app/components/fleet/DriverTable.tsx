							...
							>
								...
								<td
									className={`py-2.5 px-4 font-medium ${
										record.assignedVehicle === "Unassigned"
											? "text-[#515F74]"
											: "text-[#000000]"
									}`}
								>
								...
								<td className="py-2.5 px-4">
									<p
										className={`font-medium ${
											record.isLicenseOverdue ? "text-[#93000A]" : "text-[#000000]"
										}`}
									>
									...
									<p
										className={`text-[10px] font-medium mt-0.5 ${
											record.isLicenseOverdue ? "text-[#93000A]" : "text-[#515F74]"
										}`}
									>
								...
								<td className="py-2.5 px-4">
									<span
										className={`inline-flex items-center gap-1.5 self-start rounded-full px-2.5 py-1 text-[11px] font-medium tracking-wide ${
											STATUS_STYLES[record.status] ?? STATUS_STYLES["Available"]
										}`}
									>
