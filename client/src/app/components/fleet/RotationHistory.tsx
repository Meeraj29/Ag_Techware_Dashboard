      ...
      <div className="relative pl-3">
        ...
        <div className="space-y-6">
          {rotationLogs.map((log) => {
            const Icon = log.type === "rotation" ? RefreshCw : log.type === "repair" ? AlertCircle : Wrench;
            const iconBg = log.type === "rotation" ? "bg-blue-50 text-blue-500" : log.type === "repair" ? "bg-red-50 text-red-500" : "bg-gray-100 text-gray-500";
            ...
            return (
              <div key={log.id} className="relative flex gap-4">
                ...
                <div className="flex-1 pb-2">
                  ...
                  <h4 className="text-sm font-bold text-gray-900 mb-0.5">{log.vehicle}</h4>
