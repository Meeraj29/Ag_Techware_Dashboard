    ...
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div className="w-full md:w-auto">
          <h1 className="text-lg font-semibold text-black">Welcome back, Super Admin</h1>
          <p className="text-base font-normal text-black/70 mt-1">Real-time oversight of global supply chain logistics.</p>
        </div>
      ...
      <ManageMetricsModal isOpen={showMetrics} onClose={() => setShowMetrics(false)} />
