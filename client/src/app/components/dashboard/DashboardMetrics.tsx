...
import { Ship, Clock, CheckCircle, FileText, IndianRupee, CreditCard } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6">
      {metricCards.map((card, idx) => (
        <div key={idx} className="bg-[#F4F4F4] rounded-xl p-5 border border-[#EDEDED] flex flex-col justify-between h-36 relative overflow-hidden">
          <div className="flex justify-between items-start">
            <span className="text-2xl font-semibold text-black">{card.value}</span>
          ...
          <div className="flex justify-between items-end">
            ...
            <span
              className={`text-xs font-bold px-2 py-1 rounded-full ${card.change === "Stable"
