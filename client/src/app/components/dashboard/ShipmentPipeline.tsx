				...
				<div className="flex justify-between items-start mt-6 min-w-[600px] w-full">
					{steps.map((step, idx) => (
						<Link
							href={`/${step.link}`}
							key={idx}
							className="group flex flex-col items-center relative flex-1 cursor-pointer min-w-[120px]"
						>
							{/* Icon */}
							...
							<span className="text-sm font-medium text-[#054890] whitespace-nowrap mt-1">
