      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-row items-center justify-between gap-6 flex-1">
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-[#000000] mb-2">On-Time Performance</h2>
            <p className="text-md font-regular text-[#000000] mb-6">
              Across all active corridors, efficiency is trending <span className="text-[#059669] font-medium">upward by 2.4%</span>.
            </p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex-1">
          <h2 className="text-lg font-semibold text-[#000000] mb-6">Regional Performance Distribution</h2>
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 flex">
                <div className="bg-[#10B981] h-2 rounded-full" style={{ width: "98.4%" }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-[#F59E0B] h-2 rounded-full" style={{ width: "92.7%" }}></div>
              </div>
            </div>
          </div>
        </div>
