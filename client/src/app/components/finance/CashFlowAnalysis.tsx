  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-[16px] sm:text-[18px] lg:text-[20px] font-semibold text-[#000000]">Cash Flow Analysis</h2>
        ...
        <div className="flex-1 flex flex-col justify-between relative pl-2 sm:pl-6 pr-2 sm:pr-4 pb-6">
          ...
          <div className="flex-1 flex items-end justify-around relative z-10 w-full pt-6">
            {chartData.map((data, idx) => (
              <div key={idx} className="flex gap-1 items-end h-full relative group">
                <div 
      ...
      <div className="flex justify-center items-center gap-6 mt-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] text-gray-600 font-medium">Out Flow</span>
        </div>
      </div>
    </div>
  );
